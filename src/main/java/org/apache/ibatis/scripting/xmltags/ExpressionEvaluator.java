...
public class ExpressionEvaluator {
    ...
    public boolean evaluateBoolean(String expression, Object parameterObject) {
        //非常简单，就是调用ognl
        // 打开ExpressionEvaluator 类，发现解析表达式使用的是OGNL，如果你使用过古老的Struts框架你应该对它不陌生。
        // 通过OgnlCache.getValue(expression, parameterObject);可以看到表达式的值是从缓存中获取的，
        // 由此可知MyBatis竟然对表达式也做了缓存，以提高性能。
