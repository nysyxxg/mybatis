...
public class DynamicSqlSourceTest extends BaseDataTest {
    ...
    public void shouldDemonstrateSimpleExpectedTextWithNoLoopsOrConditionals() throws Exception {
        ...
        DynamicSqlSource source = createDynamicSqlSource2(sqlNode);
        BoundSql boundSql = source.getBoundSql(null);
        String resSQL = boundSql.getSql();
        System.out.println(expected.equals(resSQL));
        assertEquals(expected,resSQL);
    }
    ...
    private DynamicSqlSource createDynamicSqlSource2(SqlNode... contents) throws IOException, SQLException {
        //createBlogDataSource();
